...
const MOCK_CITAS = {
    1: { pet: "Max",     date: "10/10/2024", time: "10:00 AM", vet: "Dr. García", service: "Chequeo Anual" },
    2: { pet: "Charlie", date: "10/10/2024", time: "11:30 AM", vet: "Dr. García", service: "Vacunación"    },
    3: { pet: "Bella",   date: "10/10/2024", time: "2:30 PM",  vet: "Dr. García", service: "Consulta"      },
};
...
export function AtenderCita() {
    ...
    const handleSubmit = (e) => {
        ...
        console.log("Cita terminada:", { peso, temperatura, sintomas, diagnostico, tratamiento, medicamentos });
                        ...
                        <div className="atender-top-grid">
                            ...
                            <div className="atender-col-left">
                                ...
                                <div className="cita-info-box">
                                    <div className="cita-info-row"><span>Mascota:</span><strong>{cita.pet}</strong></div>
                                    <div className="cita-info-row"><span>Fecha:</span><strong>{cita.date}, {cita.time}</strong></div>
                                    <div className="cita-info-row"><span>Veterinario:</span><strong>{cita.vet}</strong></div>
                                    <div className="cita-info-row"><span>Servicio:</span><strong>{cita.service}</strong></div>
                                </div>
                                    ...
                                    {medicamentos.map((med, index) => (
                                        <div key={med.id} className="medicamento-block">
                                            ...
                                            <div className="med-block-header">
                                                <span className="med-block-num">Medicamento {index + 1}</span>
                                            ...
                                            <div className="atender-field">
                                                ...
                                                <input
                                                    type="text"
                                                    value={med.nombre}
                                                    onChange={(e) => handleMedChange(med.id, "nombre", e.target.value)}
                                            ...
                                            <div className="atender-row-two">
                                                <div className="atender-field">
                                                    ...
                                                    <input
                                                        type="text"
                                                        value={med.dosis}
                                                        onChange={(e) => handleMedChange(med.id, "dosis", e.target.value)}
                                                        placeholder="Ej. 5mg"
                                                    />
                                                </div>
                                                <div className="atender-field">
                                                    ...
                                                    <div className="input-freq-wrapper">
                                                        <input
                                                            ...
                                                            onChange={(e) => handleMedChange(med.id, "frecuencia", e.target.value)}
                                                            placeholder="Ej. 2"
                                                        />
                                            ...
                                            <div className="atender-field">
                                                ...
                                                <input
                                                    type="text"
                                                    value={med.duracion}
                                                    onChange={(e) => handleMedChange(med.id, "duracion", e.target.value)}
                                            ...
                                            <div className="atender-field">
                                                ...
                                                <textarea
                                                    value={med.notas}
                                                    onChange={(e) => handleMedChange(med.id, "notas", e.target.value)}
