...
export function AdminPets() {
    ...
    const filtered = pets.filter((p) => {
        ...
        const ownerFull = `${p.owner?.name || ""} ${p.owner?.paternalLastName || ""}`.toLowerCase();
        return (
            ...
            <main className="adminpets-main">
                ...
                <div className="adminpets-table-wrapper">
                    <table className="adminpets-table">
                        ...
                        <tbody>
                            {loading ? (
                                <tr><td colSpan={5} className="empty-row">Cargando datos...</td></tr>
                            ) : filtered.length === 0 ? (
                                <tr><td colSpan={5} className="empty-row">No hay registros que mostrar.</td></tr>
                            ) : (
                                filtered.map((pet) => (
                                    <tr key={pet._id}>
                                        ...
                                        <td className="col-status">
                                            <span className={`pet-badge ${pet.isActive ? "badge-activo" : "badge-inactivo"}`}>
                                        ...
                                        <td className="col-action">
                                            <button
                                                ...
                                                title={pet.isActive ? "Desactivar mascota" : "Activar mascota"}
                                            >
                ...
                {pagination.totalPages > 1 && (
                    <div className="pagination-container">
                        ...
                        <div className="pagination-info">
                            Página {pagination.page} de {pagination.totalPages} ({pagination.total} mascotas en total)
                        </div>
                    </div>
                )}
            </main>
