...
export function RegisterVet() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            formData.append('role', 'vet'); // rol fijo para veterinario
            ...
            if (!res.ok) {
                ...
                throw new Error(err.message || 'Error al registrar veterinario');
            }

            alert('Veterinario registrado exitosamente.');
            navigate('/admin/veterinarios');
        } catch (error) {
            alert(error.message || 'Error al registrar veterinario');
        } finally {
            setLoading(false);
        }
    };
