...
import { getProfile } from "../../services/Client/profile.js"; // ← Importa el servicio
	...
	return (
		<nav className="navbar-vet">
			...
			<ul className="nav-center">
				<li>
					<Link to="/veterinario" className={isActive("/veterinario")}>
						Inicio
					</Link>
				</li>
				<li>
					<Link to="/vet-historial" className={isActive("/vet-historial")}>
						Historial
					</Link>
				</li>
			</ul>
